#ifndef GPUSVM_SVMTRAINH
#define GPUSVM_SVMTRAINH
 ...
 */
void performTraining(float* data, int nPoints, int nDimension, float* labels, float** alpha, Kernel_params* kp, float cost, int maxIterationCount = 0xFFFF, SelectionHeuristic heuristicMethod = ADAPTIVE, float epsilon = 1e-5f, float tolerance = 1e-3f, float* transposedData = 0);
