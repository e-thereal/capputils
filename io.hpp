...
void print(const tbblas::tensor_base<T, dim, device>& tensor, int precision = 6,
    std::ostream& out = std::cout) {
  out << "Cannot print tensors of dimension > 2." << std::endl;
}

template<class T, bool device>
void print(const tbblas::tensor_base<T, 0u, device>& tensor, int precision = 6,
    std::ostream& out = std::cout)
{
  out << "[1 x 1]" << std::endl;
...
template<class T, bool device>
void print(const tbblas::tensor_base<T, 1u, device>& tensor, int precision = 6,
    std::ostream& out = std::cout)
{
...
template<class T, bool device>
void print(const tbblas::tensor_base<T, 2u, device>& tensor, int precision = 6,
    std::ostream& out = std::cout)
{
...
template<class T, unsigned dim, bool device>
std::ostream& operator<<(std::ostream& os, const tbblas::tensor_base<T, dim, device>& tensor) {
  print(tensor, 6, os);
  return os;
}
