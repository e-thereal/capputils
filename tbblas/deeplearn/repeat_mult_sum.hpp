...
#ifndef TBBLAS_DEEPLEARN_REPEAT_MULT_SUM_HPP_
#define TBBLAS_DEEPLEARN_REPEAT_MULT_SUM_HPP_
...
template<class T>
struct is_operation<tbblas::deeplearn::repeat_mult_sum_operation<T> > {
  static const bool value = true;
};

template<class T>
struct is_inc_operation<tbblas::deeplearn::repeat_mult_sum_operation<T> > {
  static const bool value = true;
};

}

#endif /* TBBLAS_DEEPLEARN_REPEAT_MULT_SUM_HPP_ */
