...
#ifndef TBBLAS_DEEPLEARN_MULT_SUM_HPP_
#define TBBLAS_DEEPLEARN_MULT_SUM_HPP_
...
template<class T>
struct is_operation<tbblas::deeplearn::conj_mult_sum_operation<T> > {
  static const bool value = true;
};

}

#endif /* TBBLAS_DEEPLEARN_MULT_SUM_HPP_ */
