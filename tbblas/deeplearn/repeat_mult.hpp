...
#ifndef TBBLAS_DEEPLEARN_REPEAT_MULT_HPP_
#define TBBLAS_DEEPLEARN_REPEAT_MULT_HPP_
...
template<class T>
struct is_operation<tbblas::deeplearn::conj_repeat_mult_operation<T> > {
  static const bool value = true;
};

template<class T>
struct is_inc_operation<tbblas::deeplearn::conj_repeat_mult_operation<T> > {
  static const bool value = true;
};

}

#endif /* TBBLAS_DEEPLEARN_REPEAT_MULT_HPP_ */
